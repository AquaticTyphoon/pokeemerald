...
static void (* const sBattleTowerFuncs[])(void) =
{
    ...
    [BATTLE_TOWER_FUNC_LOAD_PARTNERS]       = BattleTowerNop1,
...
{
    u16 move = gFacilityTrainerMons[monId].moves[0];
    u16 species = gFacilityTrainerMons[monId].species;
    SetFacilityPtrsGetLevel();
