...
{
    [HEAL_LOCATION_SCARLET_BAY_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_BRENDANS_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_SCARLET_BAY - 1] = {MAP_GROUP(SCARLET_BAY), MAP_NUM(SCARLET_BAY), 14, 13},
